...
class TestApp(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.assertEqual(app.printTopSimilarTweets(matrix, 'russia is leaded by putin', cleantweet, tweetIds, n=1), res1)
        self.assertEqual(app.printTopSimilarTweets(matrix, 'obamacare is great', cleantweet, tweetIds, n=3), res2)        
